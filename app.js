...
var $author$project$Main$greet = function (name) {
	return (name === 'Aaron') ? 'Greetings, repository ruler!' : 'Hello world!';
};
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Main$greet('Aaron') + (' ' + $elm$core$String$fromInt(model)))
					])),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
